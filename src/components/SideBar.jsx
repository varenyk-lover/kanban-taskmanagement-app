            ...
            <div
                className={
                    isSideBarOpen
                        ...
                        : ` bg-[#635FC7] dark:bg-[#2b2c37] dark:hover:bg-[#635FC7] top-auto bottom-10 justify-center 
                        items-center hover:opacity-80 cursor-pointer  p-0 transition duration-300 transform fixed 
                        flex w-[56px] h-[48px] rounded-r-full  `
                }
            >
                <div>
                            ...
                            <div className='flex flex-col h-[70vh] justify-between'>
                                <div>
                                    {boards.map((board, index) => (
                                        <div
                                            className={`flex items-baseline px-5 mr-8 rounded-r-full space-x-2
                                             duration-500 easy-in-out py-4 cursor-pointer hover:bg-[#635fc71a] 
                                             hover:text-[#635fc7] dark:hover:bg-white dark:hover:text-[#635fc7]
                                              dark:text-white ${board.isActive && 'bg-[#635fc7] rounded-r-full ' +
                                            'text-white mr-8'}`} key={index}
...
hover:bg-[#635fc71a] hover:text-[#635fc7] dark:hover:bg-white`}>
                                ...
                                <div className={`mx-2 py-4 relative space-x-2 bg-slate-100 dark:bg-[#20212c] 
                    ...
                    {isSideBarOpen ? (
                        ...
                        <div className="  flex left-4  absolute bottom-4"
                             onClick={() => toggleSidebar()}>

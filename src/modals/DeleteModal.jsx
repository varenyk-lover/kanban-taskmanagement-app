...
const DeleteModal = ({type, title, onDeleteBtnClick, setIsDeleteModalOpen}) => {
    return (
        //Modal Container
        <div
            className='fixed ring-0 bottom-0 top-0 px-2 py-4 overflow-scroll scrollbar-hide z-50 justify-center
        ...
        >
            {/*Delete Modal  */}
            <div className='scrollbar-hide overflow-y-scroll max-w-md max-h-[95vh] my-auto bg-white dark:bg-[#2b2c37] text-black
                ...
                <div className='flex w-full mt-4 items-center justify-center space-x-4'>
                 <button
                    ...
                    <button
                        ...
                        className='w-full items-center font-semibold text-[#635fc7]] hover:opacity-75
